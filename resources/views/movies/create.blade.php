    ...
    <div class="card-custom">
        <form action="{{ route('movies.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" value="{{ old('title') }}" class="form-control" placeholder="Enter movie title...">
            </div>

            <div class="mb-3">
                <label class="form-label">Genre</label>
                <input type="text" name="genre" value="{{ old('genre') }}" class="form-control" placeholder="Can be separated by commas (e.g., Action, Comedy)">
            </div>
