    ...
    <div class="card-custom">
        <form action="{{ route('movies.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" value="{{ old('title') }}" class="form-control" placeholder="Masukkan judul movie...">
            </div>

            <div class="mb-3">
                <label class="form-label">Genre</label>
                <input type="text" name="genre" value="{{ old('genre') }}" class="form-control" placeholder="Bisa dipisah koma (e.g. Action, Comedy)">
            </div>

            <div class="mb-3">
                <label class="form-label">Release Date</label>
                <input type="text" id="release_date" name="release_date" value="{{ old('release_date') }}" class="form-control date-input" placeholder="Pilih tanggal rilis">
            </div>
